class CreateTimelineEvents < ActiveRecord::Migration
  def self.up
    create_table :timeline_events do |t|
      t.string   :event_type, :account_type, :subject_type,  :actor_type,  :secondary_subject_type,  :extra_scope_type
      t.integer               :account_id,   :subject_id,    :actor_id,    :secondary_subject_id,    :extra_scope_id
      t.timestamps
    end

    add_index :timeline_events, [:account_id , :account_type]
